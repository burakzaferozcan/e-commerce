                            ...
                            @if (!empty($sizeList))
                                @foreach ($sizeList as $key => $size)
                                    <label for="size{{$key}}" class="d-flex">
                                        <input type="checkbox" id="size{{$key}}" {{isset(request()->size)&& in_array($size,request()->size) ? "checked" : ""}} class="mr-2 mt-1"> <span
                            ...
                            @if (!empty($colors))
                                @foreach ($colors as $key => $color)
                                    <label for="color{{$key}}" class="d-flex">
                                        <input type="checkbox" id="color{{$key}}" {{isset(request()->color)&& in_array($size,request()->color) ? "checked" : ""}} class="mr-2 mt-1"> <span

                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="product-total">Tutal</th>
                                ...
                                <tr class="orderItem" data-id="{{$key}}">
                                    ...
                                    <td>
                                        <div class="input-group mb-3" style="max-width: 120px;">
                                            ...
                                            <input type="text" class="form-control text-center qtyItem" value="{{$cart['qty']}}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>İndirim kodu var ise girebilirsiniz.</p>
                        </div>
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-sm" type="submit">Kupon Kodu Onayla</button>
                        </div>
                    </div>
                    </form>
                </div>
                <div class="col-md-6 pl-5">
                    <div class="row justify-content-end">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary btn-lg py-3 btn-block paymentButton"
                                       >Ödeme İşlemine Geçin</button>
                                </div>
                            </div>
                        </div>
                    </div>
